...
export { ScenarioDetailsDto } from './mqmessage/scenario-details.dto'
...
export { IndexedTopHotels } from './hotel/indexed-top-hotels'
...
export { CollectingTimesDto } from './mqmessage/collecting-times.dto'
